...
description: >
  ...
  -apple-system in lowercase weight 900 treated as graphic primitive, IBM Plex Mono chrome (uppercase,
...
typography:
  # — reading ramp —
  body:    { fontFamily: "-apple-system", cqw: 1.2, weight: 400, lineHeight: 1.6 }
  lead:    { fontFamily: "-apple-system", cqw: 1.6, weight: 400, lineHeight: 1.5 }
  caption: { fontFamily: "-apple-system", cqw: 0.9, weight: 400, lineHeight: 1.5 }
  ...
  h3:      { fontFamily: "-apple-system", cqw: 2.8, weight: 600, lineHeight: 1.2, lower: true }
  quote-text:{ fontFamily: "-apple-system", cqw: 3.8, weight: 700, lineHeight: 1.15, tracking: "-0.02em", lower: true }
  h2:      { fontFamily: "-apple-system", cqw: 4.5, weight: 700, lineHeight: 1.1, tracking: "-0.02em", lower: true }
  stat-value:{ fontFamily: "-apple-system", cqw: 5.5, weight: 900, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "-apple-system", cqw: 7.5, weight: 800, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "-apple-system", cqw: 7.5, weight: 900, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "-apple-system", cqw: 10.0, weight: 900, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "-apple-system", cqw: 10.5, weight: 900, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "-apple-system", cqw: 13.0, weight: 900, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
text and becomes graphic primitive.** -apple-system `display` at 13cqw puts a single lowercase word
